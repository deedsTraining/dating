...
main(int argc, char *argv[]) {
  ...
  lengthshingarray=i;
  printf("lengthshingarray=%d \n",lengthshingarray);
  /* printf("i=%d, shinglearray[3]=%s\n", i, shinglearray[3]);*/
  ...
  for(i=1; i<=numberoffile; i++){ 
	...
	if(!feof(currentfileptr)){
	  ...
	  /* printf("got here \n"); */
	  /*  if(i==9816){ printf("shingle=%s, loc=%d \n", shingle, location); }*/
	  if(location!=0){
