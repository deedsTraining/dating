...
main(int argc, char *argv[]) {
  ...
  strcpy(mergershinguniq, argv[1]); /* docmergersortuniq */
  strcpy(resultdateshing, argv[2]); /* dateordershingresultfile (a file to print out result to) */
